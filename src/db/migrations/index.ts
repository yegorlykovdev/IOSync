...
const migrations: Migration[] = [initialSchema, addPlcPlatform, addModuleCategories, ioListColumns, cableCoreAssignment, panelScopeCables, panelScopeHardware, uniqueRackSlotPerPanel];
